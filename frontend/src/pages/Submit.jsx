      ...
      <div className="max-w-lg mx-auto px-4 py-10">
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-400">
            Publicando como <span className="font-medium text-gray-600">{authorLabel}</span>
          </p>
        </div>

        {success && (
          <div className="bg-blue-50 border border-blue-200 text-blue-700 rounded-xl px-4 py-4 text-sm mb-6 flex items-start gap-3">
            <span className="text-blue-500 mt-0.5">✓</span>
            <div>
              <p className="font-medium">Post enviado!</p>
              <p className="text-blue-600 mt-0.5">Aguarde a aprovação de um moderador para aparecer no feed.</p>
            </div>
          </div>
        )}
