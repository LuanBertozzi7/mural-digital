...
export default function Register() {
  ...
  async function handleSubmit(e) {
    ...
    setError(null)
    try {
      const { token, user } = await apiFetch('/api/auth/register', { method: 'POST', body: JSON.stringify(form) })
    ...
    <div className="min-h-screen flex items-center justify-center px-4 animate-fade-up">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50">Criar conta</h1>
